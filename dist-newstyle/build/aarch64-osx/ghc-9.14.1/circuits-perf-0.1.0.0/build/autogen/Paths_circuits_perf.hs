...
-- at runtime using the environment variable circuits_perf_bindir.
...
-- environment variable circuits_perf_libdir.
...
-- using the environment variable circuits_perf_dynlibdir.
...
-- runtime using the environment variable circuits_perf_datadir.
...
-- variable circuits_perf_libexedir.
...
-- using the environment variable circuits_perf_sysconfdir.
...
libdir     = "/Users/tonyday567/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf/circuits-perf-0.1.0.0-inplace"
dynlibdir  = "/Users/tonyday567/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf"
datadir    = "/Users/tonyday567/.cabal/share/aarch64-osx-ghc-9.14.1-bcbf/circuits-perf-0.1.0.0"
libexecdir = "/Users/tonyday567/.cabal/libexec/aarch64-osx-ghc-9.14.1-bcbf/circuits-perf-0.1.0.0"
sysconfdir = "/Users/tonyday567/.cabal/etc"

getBinDir     = catchIO (getEnv "circuits_perf_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "circuits_perf_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "circuits_perf_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "circuits_perf_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "circuits_perf_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "circuits_perf_sysconfdir") (\_ -> return sysconfdir)
